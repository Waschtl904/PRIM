...
class ProjectMigrator:
    ...
    def migrate_notebooks(self):
        ...
        notebook_migrations = [
            (
                "prim/modul1_forisek_jancina.ipynb",
                "examples/01_forisek_jancina_algorithm.ipynb",
            ),
            ("prim/modul3_hybrid.ipynb", "examples/02_hybrid_algorithms.ipynb"),
            (
                "prim/modul4_benchmarks.ipynb",
                "examples/03_performance_benchmarks.ipynb",
            ),
            ...
            (
                "modul2_wheel_sieve/modul2_wheel_sieve.ipynb",
                "examples/02_wheel_sieve.ipynb",
            ),
        ]
    ...
    def migrate_c_extensions(self):
        ...
        c_migrations = [
            ...
            (
                "modul2_wheel_sieve/wheel_sieve.pyx",
                "native/wheel_sieve/wheel_sieve.pyx",
            ),
            (
                "modul2_wheel_sieve/wheel_sieve.cp310-win_amd64.pyd",
                "native/wheel_sieve/wheel_sieve.cp310-win_amd64.pyd",
            ),
        ]
...
''',
    ...
    def update_imports(self):
        ...
        self.log(
            "  - Change 'from prim.modulX import' to 'from prim.core/analysis import'"
        )
...
def main():
    ...
    parser.add_argument(
        "--backup", action="store_true", help="Create a backup branch before migration"
    )
